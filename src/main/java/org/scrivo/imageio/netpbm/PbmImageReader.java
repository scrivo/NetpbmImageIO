...
/**
 * This class is responsible for responding to queries about the images 
 * actually stored in an input file or stream, as well as the actual 
 * reading of images, thumbnails, and metadata. 
 * 
